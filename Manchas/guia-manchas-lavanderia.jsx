...
export default function StainGuide() {
  ...
  const [view, setView] = useState("manchas");
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        gap: 0,
        marginBottom: 24,
        borderBottom: "2px solid var(--border-color, #E0DFDB)",
      }}>
        {[
          ...
          <button
            ...
            style={{
              ...
              background: "none",
              border: "none",
              borderBottom: view === tab.id ? "2px solid var(--text-color, #1A1A1A)" : "2px solid transparent",
              marginBottom: -2,
              cursor: "pointer",
              color: view === tab.id ? "var(--text-color, #1A1A1A)" : "var(--muted-color, #888)",
              ...
              <button
                ...
                style={{
                  ...
                  border: activeStain === i
                    ? `2px solid ${s.color}`
                    : "2px solid var(--border-color, #E0DFDB)",
            ...
            return (
              <div>
                ...
                <div style={{
                  ...
                  border: "1px solid var(--border-color, #E8E7E3)",
                  borderRadius: 10,
                  padding: 16,
                  marginBottom: 16,
                }}>
                  ...
                  {s.causes.map((c, j) => (
                    <div key={j} style={{
                      padding: "8px 0",
                      borderBottom: j < s.causes.length - 1
                        ? "1px solid var(--border-color, #F0EFEB)"
                        : "none",
                    }}>
                      <div style={{ fontSize: 14, fontWeight: 600 }}>{c.name}</div>
                      <div style={{ fontSize: 12, color: "var(--muted-color, #777)", marginTop: 2 }}>
                        {c.detail}
                      </div>
                    </div>
                  ))}
                ...
                <div style={{
                  ...
                  {s.steps.map((step, j) => (
                    <div key={j} style={{
                      ...
                      gap: 12,
                      padding: "10px 0",
                      borderBottom: j < s.steps.length - 1
                        ? "1px solid var(--border-color, #F0EFEB)"
                        : "none",
                    }}>
                      <div style={{
                      ...
                      <div style={{ flex: 1 }}>
                        <div style={{ fontSize: 13, fontWeight: 700 }}>{step.produto}</div>
                        <div style={{ fontSize: 13, color: "var(--text-color, #333)", marginTop: 2 }}>
                          {step.acao}
                        </div>
                        <div style={{
                          fontSize: 12,
      ...
      {view === "procedimento" && (
        <div>
          <p style={{ fontSize: 13, color: "var(--muted-color, #777)", margin: "0 0 20px", lineHeight: 1.6 }}>
          ...
          {procedureSteps.map((step, i) => (
            <div key={i} style={{
              ...
              <div style={{
                ...
                {i < procedureSteps.length - 1 && (
                  <div style={{
                    width: 2,
                    flex: 1,
                    background: "var(--border-color, #E0DFDB)",
                    minHeight: 20,
                  }} />
                )}
              </div>
              ...
              <div style={{
                ...
                <div style={{ fontSize: 13, color: "var(--text-color, #444)", lineHeight: 1.55 }}>
                  {step.desc}
                </div>
                {step.dosagem && (
                  <div style={{
        ...
        <div>
          {[
            ...
            <div key={i} style={{
              ...
              <div style={{ fontSize: 15, fontWeight: 700, marginBottom: 2 }}>{p.nome}</div>
      ...
      <div style={{
        marginTop: 32,
        padding: "12px 0",
        borderTop: "1px solid var(--border-color, #E0DFDB)",
        fontSize: 11,
